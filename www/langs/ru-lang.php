...
define('STR_ACTION_LOGIN_2', 'Достигнут предел сессий');
...
define('STR_ACTION_PROFILE_1', 'Пользователь не найден');

define('STR_ACTION_POST_1', 'Пост не найден');

define('STR_ACTION_BIO_1', 'Не хвататет прав на смену данных');

define('STR_UNDEFINED_ERROR', 'Произошла неопознанная ошибка');
define('STR_EMPTY_DATA', 'Данные отсутствуют');
